...
const exerciseCorrections: Record<string, Partial<Exercise>> = {
  "barbell-bench-press": { subMuscles: ["mid-chest"], aliases: [lt("平板槓鈴臥推", "Flat barbell bench press"), lt("槓鈴平板臥推", "Flat barbell press")] },
  "incline-dumbbell-press": { subMuscles: ["upper-chest"], aliases: [lt("啞鈴上斜臥推", "Incline dumbbell bench press")] },
  "cable-fly": { subMuscles: ["mid-chest"], aliases: [lt("雙邊繩索夾胸", "Cable crossover"), lt("水平夾胸", "Horizontal cable fly")] },
  "dumbbell-bench-press": { subMuscles: ["mid-chest"], aliases: [lt("啞鈴平板臥推", "Flat dumbbell bench press")] },
  "smith-machine-bench-press": { subMuscles: ["mid-chest"], aliases: [lt("史密斯臥推", "Smith bench"), lt("史密斯平板臥推", "Smith flat press")] },
  "machine-chest-press": { subMuscles: ["mid-chest"], aliases: [lt("胸推器械", "Chest press machine"), lt("胸推機", "Chest press")] },
  "machine-bench-press": { subMuscles: ["mid-chest"], aliases: [lt("器械臥推", "Machine bench"), lt("臥推器械遞減", "Machine bench drop set")] },
  "incline-barbell-bench-press": { subMuscles: ["upper-chest"], aliases: [lt("槓鈴上斜", "Incline barbell"), lt("槓鈴上斜臥推", "Incline barbell bench press")] },
  "incline-machine-press": { subMuscles: ["upper-chest"], aliases: [lt("器械上斜", "Incline machine"), lt("器械上斜推", "Incline machine press")] },
  "smith-incline-press": { subMuscles: ["upper-chest"], aliases: [lt("史密斯上斜", "Smith incline"), lt("史密斯上斜臥推", "Smith incline press")] },
  "pec-deck-fly": { subMuscles: ["mid-chest"], aliases: [lt("蝴蝶夾胸", "Pec deck"), lt("蝴蝶機夾胸", "Pec deck fly")] },
  "weighted-dip": { subMuscles: ["lower-chest"], aliases: [lt("下胸負重", "Weighted lower-chest dip"), lt("負重雙槓", "Weighted dip")] },
  "high-to-low-cable-fly": { subMuscles: ["lower-chest"], aliases: [lt("向下繩索夾胸", "Downward cable fly"), lt("雙邊繩索向下夾胸", "High-to-low cable fly")] },

  "pull-up": { subMuscles: ["lats"], aliases: [lt("引體", "Pull-up")] },
  "lat-pulldown": { subMuscles: ["lats"], aliases: [lt("高位下拉", "Pulldown")] },
  "wide-grip-lat-pulldown": { subMuscles: ["lats"], aliases: [lt("寬槓下拉", "Wide-bar pulldown"), lt("寬握下拉", "Wide-grip pulldown")] },
  "straight-bar-pulldown": { subMuscles: ["lats"], aliases: [lt("龍門架平槓正握下拉", "Cable straight-bar overhand pulldown"), lt("平槓正握下拉", "Overhand straight-bar pulldown")] },
  "reverse-grip-pulldown": { subMuscles: ["lats"], aliases: [lt("龍門架窄槓反握", "Close reverse-grip cable pulldown"), lt("反握下拉", "Reverse-grip pulldown")] },
  "machine-lat-pulldown": { subMuscles: ["lats"], aliases: [lt("器械下拉", "Machine pulldown"), lt("背闊遞減", "Lat pulldown drop set"), lt("下拉遞減", "Pulldown drop set")] },
  "neutral-grip-pulldown": { subMuscles: ["lats"], aliases: [lt("對握下拉", "Neutral pulldown"), lt("對握下啦", "Neutral pulldown")] },
  "straight-arm-pulldown": { subMuscles: ["lats"], aliases: [lt("直臂下壓", "Straight-arm pulldown")] },
  "single-arm-cable-pulldown": { subMuscles: ["lats"], aliases: [lt("單邊繩索下拉", "Single-arm cable pulldown")] },
  "weighted-pull-up": { subMuscles: ["lats"], aliases: [lt("引體負重", "Weighted pull-up"), lt("負重引體", "Weighted pull-up")] },
  "seated-cable-row": { subMuscles: ["mid-back"], aliases: [lt("坐姿划船", "Seated row")] },
  "one-arm-dumbbell-row": { subMuscles: ["lats"], aliases: [lt("啞鈴划船", "Dumbbell row")] },
  "plate-loaded-row": { subMuscles: ["mid-back"], aliases: [lt("放槓片的器械划船", "Plate-loaded row"), lt("槓片式划船", "Plate-loaded row")] },
  "chest-supported-single-arm-row": { subMuscles: ["lats"], aliases: [lt("單邊靠墊划船", "Chest-supported single-arm row")] },
  "bilateral-machine-row": { subMuscles: ["mid-back"], aliases: [lt("雙邊划船", "Bilateral row"), lt("器械划船", "Machine row"), lt("雙邊器械划船", "Bilateral machine row")] },
  "narrow-grip-cable-row": { subMuscles: ["lats"], aliases: [lt("龍門架窄握划船", "Narrow-grip cable row"), lt("兩條繩子划船", "Rope cable row")] },
  "neutral-grip-cable-row": { subMuscles: ["mid-back"], aliases: [lt("龍門架對握划船", "Neutral-grip cable row"), lt("對握單手划船", "Single-arm neutral cable row")] },
  "wide-grip-cable-row": { subMuscles: ["upper-back"], aliases: [lt("龍門架寬握划船", "Wide-grip cable row")] },
  "barbell-row": { subMuscles: ["mid-back"], aliases: [lt("槓鈴划船", "Barbell row")] },
  "v-grip-t-bar-row": { subMuscles: ["mid-back"], aliases: [lt("器械海豹划船", "Seal row machine"), lt("器械海報划船", "Seal row machine"), lt("V 握划船", "V-grip row")] },
  ...
  "dumbbell-rear-delt-fly": { subMuscles: ["rear-delts"], aliases: [lt("啞鈴後束飛鳥", "Dumbbell rear-delt fly"), lt("後束飛鳥", "Rear-delt fly")] },
  "reverse-pec-deck": { subMuscles: ["rear-delts"], aliases: [lt("蝴蝶機後束", "Reverse pec deck"), lt("反向蝴蝶機", "Reverse pec deck")] },
  "cable-rear-delt-fly": { subMuscles: ["rear-delts"], aliases: [lt("龍門架後束飛鳥", "Cable rear-delt fly")] },
  "rear-delt-row": { subMuscles: ["rear-delts"], aliases: [lt("後束提拉", "Rear-delt row")] },
  "cable-front-raise": { subMuscles: ["front-delts"], aliases: [lt("繩索前平舉", "Cable front raise")] },

  "back-squat": { subMuscles: ["quads", "glute-max"], aliases: [lt("深蹲", "Squat"), lt("槓鈴深蹲", "Barbell squat")] },
  "leg-press": { subMuscles: ["quads"], aliases: [lt("腿推", "Leg press")] },
  "bulgarian-split-squat": { subMuscles: ["quads", "glute-max"], aliases: [lt("保加利亞分腿蹲", "Bulgarian split squat")] },
  "walking-lunge": { subMuscles: ["quads", "glute-max"], aliases: [lt("弓箭步", "Lunge")] },
  "leg-extension": { subMuscles: ["quads"], aliases: [lt("股四頭器械", "Quad machine"), lt("伸腿機", "Leg extension")] },
  "romanian-deadlift": { subMuscles: ["hamstrings", "glute-max"], aliases: [lt("羅馬尼亞硬舉", "RDL")] },
  "lying-leg-curl": { subMuscles: ["hamstrings"], aliases: [lt("躺姿後舉", "Lying leg curl"), lt("博繩肌", "Leg curl"), lt("腿後彎舉", "Leg curl")] },
  "deadlift": { subMuscles: ["glute-max", "hamstrings"], aliases: [lt("硬拉", "Deadlift")] },
  "hip-thrust": { subMuscles: ["glute-max"], aliases: [lt("臀推", "Hip thrust")] },
  "barbell-glute-bridge": { subMuscles: ["glute-max"], aliases: [lt("臀橋", "Glute bridge"), lt("槓鈴臀橋", "Barbell glute bridge")] },
  "smith-hip-thrust": { subMuscles: ["glute-max"], aliases: [lt("史密斯臀推", "Smith hip thrust")] },
  "hip-adduction-machine": { subMuscles: ["adductors"], aliases: [lt("內收", "Hip adduction"), lt("內收器械", "Hip adduction machine")] },
  "cable-hip-adduction": { subMuscles: ["adductors"], aliases: [lt("cable 內收", "Cable hip adduction"), lt("繩索髖內收", "Cable hip adduction")] },
  "hip-abduction-machine": { subMuscles: ["glute-med"], aliases: [lt("外展", "Hip abduction"), lt("外展器械", "Hip abduction machine")] },
  "standing-calf-raise": { subMuscles: ["calves"], aliases: [lt("站姿提踵", "Standing calf raise")] },
  "smith-calf-raise": { subMuscles: ["calves"], aliases: [lt("史密斯提踵", "Smith calf raise"), lt("史密斯提腫", "Smith calf raise")] },

  "biceps-curl": { subMuscles: ["biceps"], aliases: [lt("啞鈴二頭", "Dumbbell biceps curl")] },
  "ez-bar-curl": { subMuscles: ["biceps"], aliases: [lt("曲鋼二頭", "EZ-bar curl"), lt("曲槓二頭", "EZ-bar curl"), lt("21 禮炮", "21s curl"), lt("21禮炮", "21s curl")] },
  "cable-biceps-curl": { subMuscles: ["biceps"], aliases: [lt("龍門架二頭", "Cable biceps curl"), lt("龍門架正握二頭", "Cable curl"), lt("龍門架窄握二頭", "Close-grip cable curl")] },
  "reverse-cable-curl": { subMuscles: ["forearms", "biceps"], aliases: [lt("龍門架反握二頭", "Reverse cable curl"), lt("龍門架單邊反向二頭", "Single-arm reverse cable curl")] },
  "preacher-curl": { subMuscles: ["biceps"], aliases: [lt("牧師椅二頭", "Preacher curl")] },
  ...
  "overhead-triceps-extension": { subMuscles: ["triceps"], aliases: [lt("三頭後屈伸", "Overhead triceps extension"), lt("三頭前拉", "Cable overhead triceps extension"), lt("前拉", "Overhead cable extension")] },
  "single-arm-triceps-pressdown": { subMuscles: ["triceps"], aliases: [lt("三頭單臂下壓", "Single-arm triceps pressdown"), lt("單手背對下拉", "Single-arm reverse-grip pressdown")] },
  "cable-triceps-kickback": { subMuscles: ["triceps"], aliases: [lt("繩索三頭後踢", "Cable triceps kickback")] },
  "forearm-reverse-curl": { subMuscles: ["forearms"], aliases: [lt("小臂反向彎舉", "Reverse curl"), lt("小臂正握", "Overhand forearm curl")] },
  "wrist-curl": { subMuscles: ["forearms"], aliases: [lt("小臂椅子上屈", "Wrist curl"), lt("小臂 cable 下抓", "Cable wrist curl"), lt("小臂前後", "Wrist curl sequence")] },
  "reverse-wrist-curl": { subMuscles: ["forearms"], aliases: [lt("小臂反握", "Reverse wrist curl"), lt("小臂上屈", "Reverse wrist curl")] },

  "plank": { subMuscles: ["abs"] },
  "hanging-leg-raise": { subMuscles: ["abs"], aliases: [lt("懸掛抬腿", "Hanging leg raise"), lt("懸垂抬腿", "Hanging leg raise")] },
  "cable-crunch": { subMuscles: ["abs"], aliases: [lt("跪姿捲腹", "Kneeling cable crunch"), lt("跪姿繩索捲腹", "Cable crunch")] },
  "incline-bench-crunch": { subMuscles: ["abs"], aliases: [lt("躺椅捲腹", "Incline bench crunch")] },
  "lying-crunch": { subMuscles: ["abs"], aliases: [lt("躺姿捲腹", "Lying crunch")] },
  "cable-oblique-crunch": { subMuscles: ["obliques", "abs"], aliases: [lt("腹外斜 cable", "Cable oblique crunch"), lt("繩索腹外斜", "Cable oblique crunch")] },
};
...
export const foods: Food[] = [
  ...
  { slug: "salmon", name: { zh: "鮭魚", en: "Salmon" }, unit: { zh: "100 g 熟重", en: "100 g cooked" }, kcal: "205", protein: "22 g", carbs: "0 g", fat: "12 g", bestUse: { zh: "高蛋白加 omega-3 脂肪來源", en: "Protein plus omega-3 fat source" }, note: { zh: "脂肪較高，減脂期要算進總熱量。", en: "Higher fat, so count it during fat loss." } },
  { slug: "canned-tuna", name: { zh: "水煮鮪魚罐頭", en: "Canned Tuna in Water" }, unit: { zh: "100 g 瀝乾", en: "100 g drained" }, kcal: "115", protein: "26 g", carbs: "0 g", fat: "1 g", bestUse: { zh: "方便高蛋白，適合外食或備餐補缺口", en: "Convenient lean protein for meals or protein gaps" }, note: { zh: "不同品牌鈉含量差很多。", en: "Sodium varies a lot by brand." } },
  { slug: "shrimp", name: { zh: "蝦仁", en: "Shrimp" }, unit: { zh: "100 g 熟重", en: "100 g cooked" }, kcal: "100", protein: "24 g", carbs: "0 g", fat: "0.5 g", bestUse: { zh: "低脂高蛋白，適合減脂期換口味", en: "Lean protein option during fat loss" }, note: { zh: "沾醬和油炒會增加熱量。", en: "Sauces and oil change calories." } },
  { slug: "pork-tenderloin", name: { zh: "豬里肌", en: "Pork Tenderloin" }, unit: { zh: "100 g 熟重", en: "100 g cooked" }, kcal: "150", protein: "27 g", carbs: "0 g", fat: "4 g", bestUse: { zh: "相對低脂的肉類蛋白來源", en: "Relatively lean meat protein" }, note: { zh: "部位不同脂肪差異很大。", en: "Different cuts vary greatly in fat." } },
  ...
  { slug: "brown-rice", name: { zh: "熟糙米飯", en: "Cooked Brown Rice" }, unit: { zh: "100 g", en: "100 g" }, kcal: "112", protein: "2.6 g", carbs: "23 g", fat: "0.9 g", bestUse: { zh: "纖維較多的主食選擇", en: "Higher-fiber staple option" }, note: { zh: "不一定比白飯神奇，重點仍是份量。", en: "Not magic compared with white rice; serving size still matters." } },
  ...
  { slug: "soy-milk", name: { zh: "無糖豆漿", en: "Unsweetened Soy Milk" }, unit: { zh: "250 ml", en: "250 ml" }, kcal: "85", protein: "8 g", carbs: "3 g", fat: "4 g", bestUse: { zh: "便利植物蛋白，適合早餐或點心", en: "Convenient plant protein for breakfast or snacks" }, note: { zh: "加糖豆漿熱量會高很多。", en: "Sweetened soy milk is much higher in calories." } },
  { slug: "edamame", name: { zh: "毛豆", en: "Edamame" }, unit: { zh: "100 g 去殼", en: "100 g shelled" }, kcal: "120", protein: "11 g", carbs: "9 g", fat: "5 g", bestUse: { zh: "植物蛋白、纖維和飽足感", en: "Plant protein, fiber, and satiety" }, note: { zh: "鹽味毛豆鈉含量較高。", en: "Salted edamame can be high sodium." } },
  ...
  { slug: "low-fat-milk", name: { zh: "低脂牛奶", en: "Low-Fat Milk" }, unit: { zh: "250 ml", en: "250 ml" }, kcal: "105", protein: "8 g", carbs: "12 g", fat: "2.5 g", bestUse: { zh: "想補蛋白但控制脂肪時使用", en: "Protein and carbs with less fat" }, note: { zh: "乳糖不耐者要依個人狀況調整。", en: "Adjust if lactose intolerant." } },
  ...
  { slug: "potato", name: { zh: "馬鈴薯", en: "Potato" }, unit: { zh: "100 g 蒸/煮", en: "100 g boiled" }, kcal: "87", protein: "2 g", carbs: "20 g", fat: "0.1 g", bestUse: { zh: "飽足感高的碳水來源", en: "Filling carbohydrate source" }, note: { zh: "油炸後完全是另一種熱量密度。", en: "Frying changes the calorie density completely." } },
  { slug: "whole-wheat-toast", name: { zh: "全麥吐司", en: "Whole-Wheat Toast" }, unit: { zh: "1 片", en: "1 slice" }, kcal: "90", protein: "4 g", carbs: "16 g", fat: "1.5 g", bestUse: { zh: "早餐或訓練前後方便碳水", en: "Convenient breakfast or training carb" }, note: { zh: "抹醬通常比吐司本身更容易超熱量。", en: "Spreads often add more calories than the toast." } },
  { slug: "rice-ball", name: { zh: "便利商店飯糰", en: "Convenience-Store Rice Ball" }, unit: { zh: "1 個", en: "1 piece" }, kcal: "180-250", protein: "4-8 g", carbs: "35-45 g", fat: "2-8 g", bestUse: { zh: "訓練前後快速主食", en: "Quick staple before or after training" }, note: { zh: "內餡和美乃滋會讓熱量差很多。", en: "Fillings and mayo change calories a lot." } },
  { slug: "tea-egg", name: { zh: "茶葉蛋", en: "Tea Egg" }, unit: { zh: "1 顆", en: "1 egg" }, kcal: "75", protein: "6 g", carbs: "1 g", fat: "5 g", bestUse: { zh: "便利商店便宜蛋白補充", en: "Cheap convenience-store protein" }, note: { zh: "鈉含量比白煮蛋高。", en: "Higher sodium than plain boiled eggs." } },
  { slug: "chicken-salad", name: { zh: "雞胸沙拉", en: "Chicken Salad" }, unit: { zh: "1 盒", en: "1 pack" }, kcal: "180-300", protein: "18-28 g", carbs: "8-20 g", fat: "4-15 g", bestUse: { zh: "外食減脂時快速組一餐", en: "Fast cutting meal when eating out" }, note: { zh: "醬包常是熱量關鍵。", en: "Dressing is often the calorie driver." } },
  { slug: "protein-shake", name: { zh: "乳清蛋白飲", en: "Whey Protein Shake" }, unit: { zh: "1 份", en: "1 serving" }, kcal: "110-140", protein: "20-25 g", carbs: "2-6 g", fat: "1-3 g", bestUse: { zh: "補蛋白缺口，不是取代正餐的魔法", en: "Fills protein gaps; not magic meal replacement" }, note: { zh: "不同品牌差異大，仍要看標籤。", en: "Brands vary; check the label." } },
  { slug: "protein-bar", name: { zh: "蛋白棒", en: "Protein Bar" }, unit: { zh: "1 條", en: "1 bar" }, kcal: "180-250", protein: "15-25 g", carbs: "15-30 g", fat: "5-10 g", bestUse: { zh: "不方便吃正餐時救急", en: "Backup option when meals are not available" }, note: { zh: "有些更像甜點，要看熱量和糖醇。", en: "Some are closer to candy; check calories and sugar alcohols." } },
  { slug: "almonds", name: { zh: "杏仁", en: "Almonds" }, unit: { zh: "30 g", en: "30 g" }, kcal: "175", protein: "6 g", carbs: "6 g", fat: "15 g", bestUse: { zh: "增肌期補熱量和脂肪", en: "Adds calories and fats during gaining" }, note: { zh: "健康但熱量密度高，減脂期容易吃過量。", en: "Healthy but calorie-dense and easy to overeat." } },
  { slug: "avocado", name: { zh: "酪梨", en: "Avocado" }, unit: { zh: "100 g", en: "100 g" }, kcal: "160", protein: "2 g", carbs: "9 g", fat: "15 g", bestUse: { zh: "脂肪來源和飽足感", en: "Fat source and satiety" }, note: { zh: "不是高蛋白食物。", en: "Not a high-protein food." } },
  { slug: "olive-oil", name: { zh: "橄欖油", en: "Olive Oil" }, unit: { zh: "1 湯匙", en: "1 tbsp" }, kcal: "120", protein: "0 g", carbs: "0 g", fat: "14 g", bestUse: { zh: "烹調脂肪來源", en: "Cooking fat source" }, note: { zh: "很健康也很高熱量，倒油要算。", en: "Healthy but very calorie-dense; count the pour." } },
  { slug: "broccoli", name: { zh: "花椰菜", en: "Broccoli" }, unit: { zh: "100 g", en: "100 g" }, kcal: "35", protein: "2.8 g", carbs: "7 g", fat: "0.4 g", bestUse: { zh: "減脂期增加份量和纖維", en: "Adds food volume and fiber during fat loss" }, note: { zh: "醬料和油才常是熱量來源。", en: "Sauces and oil are often the calorie source." } },
  { slug: "apple", name: { zh: "蘋果", en: "Apple" }, unit: { zh: "1 顆中型", en: "1 medium" }, kcal: "95", protein: "0.5 g", carbs: "25 g", fat: "0.3 g", bestUse: { zh: "點心、纖維和飽足感", en: "Snack, fiber, and satiety" }, note: { zh: "果汁和整顆水果不是同一種飽足感。", en: "Juice and whole fruit do not fill you the same way." } },
  { slug: "sweetened-milk-tea", name: { zh: "含糖奶茶", en: "Sweetened Milk Tea" }, unit: { zh: "1 杯 500 ml", en: "1 cup, 500 ml" }, kcal: "300-500", protein: "4-8 g", carbs: "45-80 g", fat: "8-18 g", bestUse: { zh: "想喝可以安排，但不適合作為日常補蛋白", en: "Can be planned in, but not a daily protein strategy" }, note: { zh: "珍珠、奶蓋和全糖會讓熱量再上去。", en: "Boba, cream tops, and full sugar push calories higher." } },
];
