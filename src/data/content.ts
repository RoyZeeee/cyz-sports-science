...
export const faqs: Faq[] = [
  ...
  {
    slug: "do-carbs-at-night-make-you-fat",
    lang: "zh",
    title: "晚上吃碳水會胖嗎？",
    description: "變胖主要看長期熱量盈餘，不是碳水出現的時間本身。",
    topic: "fat-loss",
    audience: "減脂新手、上班族、學生",
    evidence: "strong",
    answer: [
      "晚上吃碳水不會因為時間點就自動變成脂肪。體脂變化主要看一段時間內總熱量、活動量、蛋白質和訓練安排。",
      "真正容易出問題的是晚上太餓，搭配零食、含糖飲、炸物或大份量外食，讓總熱量超標。",
      "如果晚上訓練，晚餐保留一些白飯、地瓜或水果反而可能幫助恢復和隔天訓練狀態。",
    ],
    takeaways: ["時間點不是魔法。", "總熱量和份量更重要。", "晚上訓練者可以保留合理碳水。"],
    relatedEvidence: ["carbohydrate-refueling"],
    relatedArticle: "calorie-deficit-basics",
  },
  {
    slug: "can-i-drink-milk-tea-while-cutting",
    lang: "zh",
    title: "減脂可以喝奶茶嗎？",
    description: "可以安排，但含糖奶茶常是熱量赤字被吃掉的地方。",
    topic: "fat-loss",
    audience: "學生、上班族、減脂新手",
    evidence: "moderate",
    answer: [
      "減脂不是完全不能喝奶茶，但奶茶、珍珠、奶蓋和全糖常常一杯就有 300-500 kcal，會快速吃掉一天的赤字。",
      "如果想喝，先降低頻率和糖量，或把它當作有成本的點心，而不是無熱量飲料。",
      "比較穩的策略是保留蛋白質和正餐，再決定奶茶是否還放得進當天總熱量。",
    ],
    takeaways: ["可以喝，但要算成本。", "半糖不等於低熱量。", "先保蛋白質和正餐。"],
    relatedEvidence: ["concurrent-training"],
    relatedArticle: "calorie-deficit-basics",
  },
  {
    slug: "how-many-eggs-per-day",
    lang: "zh",
    title: "一天可以吃幾顆蛋？",
    description: "雞蛋很方便，但要和整天脂肪、熱量與健康情境一起看。",
    topic: "supplements",
    audience: "學生、增肌、減脂",
    evidence: "moderate",
    answer: [
      "一顆蛋大約 70 kcal、6 g 蛋白質和 5 g 脂肪。它是很方便的食物，但不是純蛋白質。",
      "健身者一天吃幾顆蛋沒有固定答案，要看總蛋白、總脂肪、總熱量，以及是否有血脂或醫療限制。",
      "如果只是想補蛋白，雞胸、鮪魚、豆腐、希臘優格或蛋白飲有時更容易把蛋白質拉高而不帶太多脂肪。",
    ],
    takeaways: ["雞蛋方便但有脂肪。", "看整天飲食，不看單一食物。", "有醫療限制先問專業人員。"],
    relatedEvidence: ["protein-supplementation"],
    relatedArticle: "protein-powder-is-a-tool",
  },
  {
    slug: "are-protein-bars-good-for-lifting",
    lang: "zh",
    title: "蛋白棒適合健身嗎？",
    description: "蛋白棒適合救急，但不一定低熱量，也不該取代日常食物。",
    topic: "supplements",
    audience: "學生、上班族、外食族",
    evidence: "moderate",
    answer: [
      "蛋白棒最適合用在沒時間吃正餐、通勤、上課或訓練後臨時補蛋白的情境。",
      "但它不會因為叫蛋白棒就自動健康或低熱量。有些蛋白棒熱量、糖、脂肪都不低，更像加了蛋白質的零食。",
      "買之前先看每條熱量和蛋白質。若蛋白不高、熱量很高，就不要把它當作減脂神器。",
    ],
    takeaways: ["適合救急，不是魔法。", "先看熱量和蛋白質。", "能吃正餐時，正餐通常更穩。"],
    relatedEvidence: ["protein-supplementation"],
    relatedArticle: "supplement-priority-map",
  },
  {
    slug: "no-time-to-workout",
    lang: "zh",
    title: "沒時間健身怎麼安排？",
    description: "先用少量但穩定的全身訓練建立最低有效劑量。",
    topic: "training",
    audience: "上班族、學生、時間有限者",
    evidence: "moderate",
    answer: [
      "沒時間時，不要先追求完美課表。每週 2-3 次、每次 30-45 分鐘的全身或上下肢訓練，通常比一週計畫五天但做不到更有效。",
      "優先選推、拉、蹲或腿推、髖鉸鏈、核心這些高回報動作，再用少量孤立動作補弱點。",
      "最重要的是能持續記錄和逐步進步。忙碌族群的課表要為生活服務，不是把生活壓垮。",
    ],
    takeaways: ["先做最低可持續版本。", "每週 2-3 次也能有效。", "動作選擇要高回報。"],
    relatedEvidence: ["concurrent-training"],
    relatedArticle: "cardio-and-lifting",
  },
  {
  ...
  },
  {
    slug: "do-carbs-at-night-make-you-fat",
    lang: "en",
    title: "Do carbs at night make you fat?",
    description: "Fat gain is driven mainly by sustained calorie surplus, not the clock time of carbs.",
    topic: "fat-loss",
    audience: "Fat-loss beginners, office workers, students",
    evidence: "strong",
    answer: [
      "Eating carbohydrates at night does not automatically turn them into fat. Body-fat change depends on total calories, activity, protein, and training over time.",
      "The common problem is not the clock. It is being very hungry at night and adding snacks, sweet drinks, fried food, or large takeout portions.",
      "If you train in the evening, keeping some rice, sweet potato, or fruit at dinner can support recovery and the next session.",
    ],
    takeaways: ["Timing is not magic.", "Total calories and portions matter more.", "Evening lifters can keep reasonable carbs."],
    relatedEvidence: ["carbohydrate-refueling"],
    relatedArticle: "calorie-deficit-basics",
  },
  {
    slug: "can-i-drink-milk-tea-while-cutting",
    lang: "en",
    title: "Can I drink milk tea while cutting?",
    description: "You can fit it in, but sweet milk tea often uses up the calorie deficit fast.",
    topic: "fat-loss",
    audience: "Students, office workers, fat-loss beginners",
    evidence: "moderate",
    answer: [
      "Fat loss does not require banning milk tea, but a full-sugar milk tea with boba or cream topping can easily land around 300-500 kcal.",
      "If you want it, reduce frequency and sugar level, or treat it as a planned snack with a calorie cost, not as a free drink.",
      "A more reliable approach is to protect protein and meals first, then decide whether milk tea still fits the day.",
    ],
    takeaways: ["You can drink it, but count the cost.", "Half sugar is not zero calories.", "Protect protein and meals first."],
    relatedEvidence: ["concurrent-training"],
    relatedArticle: "calorie-deficit-basics",
  },
  {
    slug: "how-many-eggs-per-day",
    lang: "en",
    title: "How many eggs can I eat per day?",
    description: "Eggs are convenient, but the answer depends on total fat, calories, and health context.",
    topic: "supplements",
    audience: "Students, gaining, cutting",
    evidence: "moderate",
    answer: [
      "One egg is roughly 70 kcal, 6 g protein, and 5 g fat. It is convenient, but it is not pure protein.",
      "There is no universal number for lifters. Look at total protein, total fat, calories, and any blood-lipid or medical restrictions.",
      "If the goal is simply more protein, chicken, tuna, tofu, Greek yogurt, or protein shakes may add protein with less fat.",
    ],
    takeaways: ["Eggs are useful but contain fat.", "Judge the whole day, not one food.", "Medical restrictions need professional advice."],
    relatedEvidence: ["protein-supplementation"],
    relatedArticle: "protein-powder-is-a-tool",
  },
  {
    slug: "are-protein-bars-good-for-lifting",
    lang: "en",
    title: "Are protein bars good for lifting?",
    description: "Protein bars are useful backups, but they are not automatically low-calorie or better than meals.",
    topic: "supplements",
    audience: "Students, office workers, eating out",
    evidence: "moderate",
    answer: [
      "Protein bars are most useful when you have no time for a meal, are commuting, in class, traveling, or need a quick post-training backup.",
      "The name does not make them healthy or low-calorie. Some bars are basically snacks with added protein.",
      "Check calories and protein per bar. If protein is low and calories are high, it is not a fat-loss shortcut.",
    ],
    takeaways: ["Useful as backup, not magic.", "Check calories and protein.", "Real meals are usually better when available."],
    relatedEvidence: ["protein-supplementation"],
    relatedArticle: "supplement-priority-map",
  },
  {
    slug: "no-time-to-workout",
    lang: "en",
    title: "How do I work out with no time?",
    description: "Use a small but consistent full-body plan before chasing the perfect split.",
    topic: "training",
    audience: "Office workers, students, busy beginners",
    evidence: "moderate",
    answer: [
      "When time is limited, do not start with the perfect program. Two to three sessions per week, 30-45 minutes each, is often better than planning five sessions you cannot repeat.",
      "Prioritize high-return movements: push, pull, squat or leg press, hinge, and core. Add small isolation work only after the basics are covered.",
      "The goal is consistency, logging, and gradual progression. A busy-person plan should support life, not crush it.",
    ],
    takeaways: ["Start with the minimum repeatable version.", "Two to three weekly sessions can work.", "Use high-return exercises."],
    relatedEvidence: ["concurrent-training"],
    relatedArticle: "cardio-and-lifting",
  },
];
